...
import models.registration.model_examples.pojo.lombok.RegistrationBodyLombokModel;
import models.registration.model_examples.pojo.lombok.RegistrationResponceLombokModel;
import models.registration.model_examples.pojo.RegistrationBodyPojoModel;
import models.registration.model_examples.pojo.RegistrationResponcePojoModel;
import models.registration.model_examples.pojo.records.*;
...
public class RegistrationTests_with_model_examples {
    ...
    public void existingUser400Test() {
        ...
        ExistingUserResponceRecordsModel response = given()
                .log().all()
                .contentType(JSON)
                .body(data)
                .when()
                ...
                .statusCode(400)
                .extract()
                .as(ExistingUserResponceRecordsModel.class);
